...
Note:
“Do you have a baseline understanding of various important subjects in web development and can you communicate your understanding well?”
...
* Boilerplate includes your react component framework, your script tag for JQuery, html and css structure, backend scaffolding etc.
* Communicate well- remember your pair programming experience!
* Remember to test (don’t wait until you’ve coded up the entire problem before testing to see that it works)
* Analyze along the way
...
Note:
(Pay attention in Ned’s lecture)
...
* Readings email will be sent out in the evenings
